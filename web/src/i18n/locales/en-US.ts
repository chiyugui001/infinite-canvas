export default {
    ...
    dreamina: { imageModel: "Dreamina (local image)", videoModel: "Dreamina (local video)", imageModelVersion: "Dreamina {{version}} (local image)", imageModelVersionTextOnly: "Dreamina {{version}} (text-to-image only)", videoModelVersion: "{{version}} (local Dreamina video)", videoModelVersionImageOnly: "{{version}} (image-to-video only)", agentRequired: "Connect the local Agent before using Dreamina", unavailable: "Dreamina CLI was not detected on this computer", creditConfirm: "You are about to submit real Dreamina tasks.\n\nUsage: {{usage}}\nModels: {{models}}\nParameters: {{parameters}}\nCurrent credit balance: {{balance}}\nCharge: {{credits}} credits\nQuote basis: {{quoteBasis}}\n\nThe Agent will verify again before submission; changed, stale, or repriced requests will not be submitted.\nContinue?", webQuoteBasis: "Dreamina's live Edge value (including locally verified rules)", historyQuoteBasis: "{{evidenceCount}} recent settled task(s) with the same parameters", liveCreditPerImage: "{{credits}}/image", liveCreditVideo: "{{credits}} credits", liveCreditTotal: "{{credits}} credits total", liveCreditLoading: "Checking credits…", liveCreditUnavailable: "Live credits unavailable", quoteUnavailable: "No verifiable pre-submit credit quote is available for these parameters; nothing was submitted", creditUsageImages: "{{count}} images ({{tasks}} tasks)", creditUsageVideos: "{{count}} videos", creditUsageSeparator: "; ", creditBalanceUnknown: "unavailable", noMedia: "Dreamina returned no usable media", noVideo: "Dreamina returned no video" },
    ...
    canvas: {
        ...
        node: {
            ...
            dreamina: {
                phases: { submitting: "Submitting to Dreamina", submitted: "Task submitted", queued: "Queued in Dreamina", processing: "Processing in Dreamina", awaiting_confirmation: "May need confirmation", downloading: "Downloading to canvas" },
                hints: { submitting: "The request was sent to the local CLI and is waiting for a Dreamina task ID.", submitted: "The task ID is ready and its platform status is being checked.", queued: "The task is still waiting in Dreamina's queue.", processing: "Dreamina is processing the task; the canvas will refresh automatically.", awaiting_confirmation: "", downloading: "The result is ready and is being written back to the canvas." },
                confirmationHint: "The queue has finished but the task is not complete. Check Dreamina for a confirmation step before generation can continue.",
                cliStatus: "CLI {{status}}", queueStatus: "Queue {{status}}", queuePosition: "{{position}} / {{total}}", elapsed: "Waiting {{time}}",
            },
        },
        sidePanel: {
    ...
    agent: {
        ...
        eventExtra: { toolNamed: "Call tool: {{name}}", toolOperation: "Tool operation", targetPage: "Target page", searchContent: "Search query", textContent: "Text content", operationContent: "Operations", imageCount: "Image count", mediaCount: "Media count", tools: { generateImage: "Generate image", viewImage: "View image", executeCommand: "Run command", editFiles: "Edit files", searchWeb: "Search the web", canvasOps: "Canvas operations", readCanvas: "Read canvas", readSelection: "Read selection", exportSnapshot: "Export snapshot", createNode: "Create node", addAttachments: "Add attachment images", importLocalMedia: "Import local media", createText: "Create text", createTexts: "Create text nodes", createConfig: "Create generation config", createImageFlow: "Create image flow", createGenerationFlow: "Create generation flow", generateText: "Generate text", generateVideo: "Generate video", generateAudio: "Generate audio", updateNode: "Update node", updateText: "Update text", moveNodes: "Move nodes", resizeNode: "Resize node", deleteNodes: "Delete nodes", connectNodes: "Connect nodes", selectNodes: "Select nodes", setViewport: "Adjust viewport", runGeneration: "Run generation", openPage: "Open page" } },
