...
export const toolInputSchemas = {
    ...
    canvas_import_local_media: z.object({ paths: z.array(z.string()).min(1).max(20), x: z.number().optional(), y: z.number().optional(), gap: z.number().optional(), direction: z.enum(["row", "column"]).optional() }),
...
export const toolDescriptions: Record<ToolName, string> = {
    ...
    canvas_import_local_media: "把本机绝对路径指向的图片、视频或音频导入当前画布。适合导入 Dreamina/即梦 CLI 等本地工具下载的生成结果；paths 最多 20 个，网页侧会在写入前确认。",
